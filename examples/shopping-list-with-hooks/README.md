...
This example demonstrates how to use the [@reimagined/react-hooks](https://reimagined.github.io/resolve/docs/frontend#@reimagined/react-hooks-library) client library to communicate with a reSolve backend.
