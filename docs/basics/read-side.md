...
Read Models and View Models serve a similar purpose - they allow you to query the system data. In both cases this data is built based on events obtained from the event store. However, Read Models and View Models differ in both in how they treat the event data as what roll they serve in an application:
