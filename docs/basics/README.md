...
- [Write Side](write-side.md)
  - [Configuring Commands and Events](write-side.md#configuring-commands-and-events)
...
- [Read Side](read-side.md)
  ...
  - [Updating a Read Model via a Projection Function](read-side.md#updating-a-read-model-via-a-projection-function)
