...
You can communicate with the store using the [standard API](api-reference#read-model-store-interface). The code sample below demonstrates a Read Model projection function implementation:
