...
You can use the [standard API](api-reference#read-model-store-interface) to communicate with store. The code sample below demonstrates a Read Model projection function implementation:
