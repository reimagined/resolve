...
In reSolve, an aggregate's deffinition describes logic used to handle incomming commands and emit events that are then saved to the event store and propagate to the read side.
