...
> {
  ...
  saveEvent: (connection: AdapterConnection, event: EventForSave)=>Promise<void>,
  ...
  loadSnapshot: (connection: AdapterConnection, snapshotKey: string) => Promise<string>,
  saveSnapshot:  (connection: AdapterConnection, snapshotKey: string, content: string) => Promise<void>,
  dropSnapshot: (connection: AdapterConnection, snapshotKey: string) => Promise<void>,
  getSecret: (connection: AdapterConnection, selector: string) => Promise<string>,
  setSecret: (connection: AdapterConnection, selector: string, secret: string) => Promise<void>,
  deleteSecret: (connection: AdapterConnection, selector: string) => Promise<void>,
  beginIncrementalImport:  (connection: AdapterConnection) => Promise<string>,
  commitIncrementalImport:  (connection: AdapterConnection, importId: string, validateAfterCommit?: boolean ) => Promise<void>,
  rollbackIncrementalImport: (connection: AdapterConnection ) => Promise<void>,
  pushIncrementalImport: (connection: AdapterConnection, events: Array<EventForIncrementalImport>) => Promise<void>
}
...
export interface IAdapter {
  ...
  commitIncrementalImport:  (importId: string, validateAfterCommit?: boolean ) => Promise<void>,
  rollbackIncrementalImport: () => Promise<void>,
  pushIncrementalImport: (events: Array<EventForIncrementalImport>) => Promise<void>
}
