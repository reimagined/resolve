...
const createRequest = async (expressReq, resolveApiPath) => {
...
const wrapApiHandler = (handler, resolveApiPath) => async (
  expressReq,
  expressRes
) => {
  try {
    const req = await createRequest(expressReq, resolveApiPath)
