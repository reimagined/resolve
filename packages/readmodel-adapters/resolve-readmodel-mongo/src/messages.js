...
export default {
    collectionExistsNoMeta: collectionName =>
        `Collection ${collectionName} had already been created in current database, but not with resolve read model adapter and has no required meta information`,
