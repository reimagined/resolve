...
export const unicodeSymbolsForEscape = `
  [\\0-\\x1F\\x7F-\\x9F\\xAD\\u0378\\u0379\\u037F-\\u0383\\u038B
  \\u03A2\\u0528-\\u0530\\u0557\\u0558\\u0560\\u0588\\u058B-\\u058E\\u0590\\u05C8-\\u05CF
  \\u05EB-\\u05EF\\u05F5-\\u0605\\u061C\\u061D\\u06DD\\u070E\\u070F\\u074B\\u074C\\u07B2-
  \\u07BF\\u07FB-\\u07FF\\u082E\\u082F\\u083F\\u085C\\u085D\\u085F-\\u089F\\u08A1\\u08AD-
...
const apiHandlerConstructor = ({ routes, redux }) => async (req, res) => {
  const reactRouter = {
    ...
    redux: {
      reducers:
        redux.reducers != null
          ? Object.keys(redux.reducers).reduce((acc, key) => {
              acc[key] = serverImports[redux.reducers[key]]()
              return acc
            }, {})
          : {},
      sagas:
        redux.sagas != null ? redux.sagas.map(key => serverImports[key]()) : [],
      middlewares:
        redux.middlewares != null
          ? redux.middlewares.map(key => serverImports[key]())
          : [],
      enhancers:
        redux.enhancers != null
          ? redux.enhancers.map(key => serverImports[key]())
          : []
    }
  }
