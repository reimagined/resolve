...
This command will update all resolve packages to the latest version, respecting semver.
If the `version` argument is specified, this command will update packages to the specified version.
