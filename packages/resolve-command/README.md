...
* `snapshotAdapter`  
	Optional, default no snapshots. Adapter for loading and saving intermediate aggregate state.

* `snapshotBucketSize`  
	Optional, default 100 events. Event count between saving aggregate snapshot.
